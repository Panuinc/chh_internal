...
export const visitorCreateSchema = z.object({
  ...
  visitorCarRegistration: preprocessString('Please provide visitorCarRegistration'),
  ...
  visitorDocumentPhotos: z.union([
    z.array(preprocessFileFlexible()),
    preprocessFileFlexible(),
  ]).optional(),
...
export const visitorUpdateSchema = z.object({
  ...
  visitorPhoto: preprocessFileFlexible('Please provide visitorPhoto').optional(),
  visitorDocumentPhotos: z.union([
    z.array(preprocessFileFlexible()),
    preprocessFileFlexible(),
  ]).optional(),
...
export const patrolUpdateSchema = z.object({
  ...
  patrolQrCodeInfo: preprocessString('Please provide patrolQrCodeInfo'),
  patrolPicture: preprocessFileFlexible('Please provide patrolPicture').optional(),
  patrolNote: preprocessString('Please provide patrolNote'),
