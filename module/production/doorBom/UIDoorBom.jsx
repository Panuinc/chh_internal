...
export default function UIDoorBom() {
  ...
  return (
    <div
      ref={formRef}
      className="flex flex-col items-center justify-start w-full h-full p-2 gap-2 overflow-auto bg-background"
    >
