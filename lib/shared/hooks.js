...
/**
 * Shared React Hooks
 * Base hooks ใช้ร่วมกันทุก entity
 */
...
/**
 * Factory: Create useList hook for any entity
 * @param {string} apiUrl - Base API URL
 * @param {string} dataKey - Key in response (e.g., "permissions", "employees")
 * @param {Function} formatFn - Format function for each item
 */
...
/**
 * Factory: Create useItem hook for any entity
 * @param {string} apiUrl - Base API URL
 * @param {string} dataKey - Key in response (e.g., "permission", "employee")
 * @param {Function} formatFn - Format function
 */
...
/**
 * Factory: Create useSubmit hook for any entity
 * @param {string} apiUrl - Base API URL
...
export function createUseSubmit(apiUrl, defaultOptions = {}) {
  return function useSubmit(options = {}) {
    ...
    const submit = useCallback(
      ...
      [mode, itemId, currentUserId, router, onSuccess, redirectPath, redirectDelay, createdByField, updatedByField]
    );
