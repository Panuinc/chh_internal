 ...
 * Base controller utilities ใช้ร่วมกันทุก entity
 */
...
export function getPaginationParams(request) {
  ...
  return {
    page: parseInt(searchParams.get("page") || String(PAGINATION.DEFAULT_PAGE), 10),
...
/**
 * Create base controller factory
 * @param {object} options
 * @param {Function} options.getAllUseCase
 * @param {Function} options.getByIdUseCase  
 * @param {Function} options.createUseCase
 * @param {Function} options.updateUseCase
 * @param {Function} options.deleteUseCase
 * @param {Function} options.formatData
 */
