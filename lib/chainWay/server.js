import { PRINTER_CONFIG, TIMEOUTS, LABEL_SIZES, EPC_CONFIG } from "./config.js";
...
export { PRINTER_CONFIG, TIMEOUTS, LABEL_SIZES, EPC_CONFIG } from "./config.js";
...
export const PrintService = {
  async generateLabel(item, options = {}) {
    const { type = "thai", labelSize = LABEL_SIZES.STANDARD, epcMode, epcPrefix } = options;
