export const PRINTER_CONFIG = {
  host: process.env.RFID_PRINTER_IP,
  port: parseInt(
...
export const PACKING_SLIP_LABEL = {
  ...
  MARGIN: Math.round(2 * ZPL_CONFIG.dotsPerMm),
};
...
export const PACKING_SLIP_SECTIONS = {
  ...
  get HEADER_BOTTOM() {
    return this.MARGIN + Math.round(20 * ZPL_CONFIG.dotsPerMm);
  },
  get RECIPIENT_TOP() {
    return this.MARGIN + Math.round(21 * ZPL_CONFIG.dotsPerMm);
  },
  get RECIPIENT_BOTTOM() {
    return this.MARGIN + Math.round(41 * ZPL_CONFIG.dotsPerMm);
  },
  get TABLE_HEADER_TOP() {
    return this.MARGIN + Math.round(42 * ZPL_CONFIG.dotsPerMm);
  },
  get TABLE_HEADER_BOTTOM() {
    return this.MARGIN + Math.round(47 * ZPL_CONFIG.dotsPerMm);
  },
  get TABLE_BODY_TOP() {
    return this.MARGIN + Math.round(47 * ZPL_CONFIG.dotsPerMm);
  },
  get TABLE_BODY_BOTTOM() {
    return this.MARGIN + Math.round(122 * ZPL_CONFIG.dotsPerMm);
  },
  get FOOTER_TOP() {
    return this.MARGIN + Math.round(123 * ZPL_CONFIG.dotsPerMm);
  },
  get FOOTER_BOTTOM() {
    return this.MARGIN + Math.round(148 * ZPL_CONFIG.dotsPerMm);
  },
};
...
export const API_ENDPOINTS = {
  ...
  command: "/api/chainWay/command",
  packingSlip: "/api/chainWay/packingSlip",
