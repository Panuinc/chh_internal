/**
 * EPC (Electronic Product Code) Generation Module
 * รองรับการสร้าง EPC หลายรูปแบบ: SGTIN-96, Simple, Unique
 */

let serialCounter = 0;

/**
 * สร้าง SGTIN-96 EPC ตามมาตรฐาน GS1
 * @param {Object} params - พารามิเตอร์
 * @param {string} params.companyPrefix - รหัสบริษัท (7 หลัก)
 * @param {string} params.itemRef - รหัสสินค้า (6 หลัก)
 * @param {string} params.serial - หมายเลข serial
 * @returns {string} EPC 24 ตัวอักษร hex
 */
...
/**
 * สร้าง Simple EPC แบบง่าย
 * @param {Object} params - พารามิเตอร์
 * @param {string} params.prefix - prefix (เช่น "PK")
 * @param {string} params.itemNumber - หมายเลขสินค้า
 * @param {string} params.sequence - ลำดับ
 * @returns {string} EPC 24 ตัวอักษร hex
 */
...
/**
 * สร้าง Unique EPC โดยใช้ timestamp
 * @param {Object} params - พารามิเตอร์
 * @param {string} params.prefix - prefix (เช่น "UID")
 * @returns {string} EPC 24 ตัวอักษร hex
 */
...
/**
 * EPCService - บริการจัดการ EPC
 */
export const EPCService = {
  /**
   * สร้าง EPC ตาม mode ที่กำหนด
   ...
   * @param {string} epc - EPC ที่ต้องการตรวจสอบ
  ...
  /**
   * แปลง EPC เป็นข้อมูลที่อ่านได้
   * @param {string} epc - EPC
   * @returns {Object} ข้อมูล EPC
   */
  parse(epc) {
