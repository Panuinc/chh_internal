...
const PAD = {
  top: Math.round(PADDING.top * DOTS_PER_MM),
  bottom: Math.round(PADDING.bottom * DOTS_PER_MM),
  left: Math.round(PADDING.left * DOTS_PER_MM),
  right: Math.round(PADDING.right * DOTS_PER_MM),
};
